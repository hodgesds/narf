...
pub use mempolicy::{
    ...
    interleave_weight, peek_interleave_node, set_active as mempolicy_set, set_interleave_weight,
    Mempolicy, MPOL_BIND, MPOL_DEFAULT, MPOL_INTERLEAVE, MPOL_LOCAL, MPOL_PREFERRED,
