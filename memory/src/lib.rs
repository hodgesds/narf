...
pub use frame::{
    ...
    node_free, rebalance_to_topology, release_early_ceiling, stats as frame_stats,
    FrameAllocError, FrameStats, PhysFrame, UsableRegion, MAX_NUMA_NODES as FRAME_MAX_NUMA_NODES,
