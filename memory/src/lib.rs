...
pub use frame::{
    alloc_frame, alloc_frame_anywhere, alloc_frame_on, alloc_pages_on, current_cpu_node,
    current_frame_alloc_name, free_frame, free_pages, hotplug_node_for_phys, init_from_map,
    install_frame_alloc, install_memory_hotplug_hook, is_numa_aware, memory_blocks, node_for_phys,
    node_free, node_free_blocks, node_total, numa_node_stats, offline_memory_range,
    online_memory_range, online_node_count, online_node_mask, rebalance_to_topology,
...
pub use swap::{
    ...
    install_default_if_unset as install_default_swap_if_unset, set_swap_batch_pages,
    swap_batch_pages, swap_discard, swap_discard_batch, swap_stats, SwapBackend, SwapError,
    SwapPte, SwapStats, ZramBackend, MAX_SWAP_AREAS, SWAP_BATCH_PAGES_DEFAULT,
