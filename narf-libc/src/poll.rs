...
// live in `crate::time` and forward to the Wave-73 kernel POSIX
// timer syscalls.  The older timerfd-backed emulation that used to
// live here predated those syscalls and has been removed.
