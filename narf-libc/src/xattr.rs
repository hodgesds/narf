...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn listxattr(_path: *const i8, _list: *mut i8, _size: usize) -> isize {
    enotsup()
}

/// `llistxattr(path, list, size)`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn llistxattr(_path: *const i8, _list: *mut i8, _size: usize) -> isize {
    enotsup()
}

/// `flistxattr(fd, list, size)`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn flistxattr(_fd: c_int, _list: *mut i8, _size: usize) -> isize {
    enotsup()
}

/// `removexattr(path, name)`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn removexattr(_path: *const i8, _name: *const i8) -> c_int {
    enotsup() as c_int
}

/// `lremovexattr(path, name)`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn lremovexattr(_path: *const i8, _name: *const i8) -> c_int {
    enotsup() as c_int
}

/// `fremovexattr(fd, name)`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn fremovexattr(_fd: c_int, _name: *const i8) -> c_int {
    enotsup() as c_int
}
