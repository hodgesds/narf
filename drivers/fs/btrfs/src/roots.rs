...
//! root node. This driver follows only the default `FS_TREE` (objectid 5); the
//! same decoder locates the CSUM and EXTENT tree roots for the Phase-7 write
//! path.
