...
impl VirtioMmioDevice {
    ...
    pub unsafe fn probe_raw(base_raw: u64) -> Result<Self, ProbeError> {
        unsafe {
            ...
            let device_id =
                core::ptr::read_volatile((base_raw + Self::REG_DEVICE_ID) as *const u32);
            if device_id == 0 {
                return Err(ProbeError::EmptySlot);
            }
