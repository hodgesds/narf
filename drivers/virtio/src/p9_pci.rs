...
impl VirtioP9Pci {
    ...
    pub fn submit(&self, req: &[u8], resp_max: usize)
    ...
    pub fn tversion(&self, msize: u32, version: &str)
        -> Result<p9::Rversion, VirtioPciError>
    {
        let req = p9::Tversion {
            tag: 0xFFFF, msize,
...
static CONTROLLER: IrqSafeSpinLock<Option<VirtioP9Pci>> =
...
pub fn probe(
    ...
    let dev = match unsafe { VirtioP9Pci::bring_up(&device, &cap) } {
        Ok(d)  => d,
