...
pub const INT_CMD_MASK: u32 =
    INT_RESPONSE | INT_TIMEOUT | INT_CRC | INT_END_BIT | INT_INDEX;
pub const INT_DATA_MASK: u32 =
    INT_DATA_END | INT_DMA_END | INT_DATA_AVAIL | INT_SPACE_AVAIL
    | INT_DATA_TIMEOUT | INT_DATA_CRC | INT_DATA_END_BIT | INT_ADMA_ERROR;
...
pub mod tests {
    ...
    kernel_test_in!("drivers/sdio/sdhci/regs", smoke_sdhci_reg_decode_key_offsets);
