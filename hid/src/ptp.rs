...
static PTP_DESCRIPTOR_BLOB: &[u8] = &[
    ...
    0xA1, 0x02, //     Collection (Logical)
    0x09, 0x42, //       Usage (Tip Switch)
    0x15, 0x00, 0x25, 0x01, 0x75, 0x01, 0x95, 0x01, 0x81, 0x02, 0x09, 0x51, 0x25, 0x07, 0x75, 0x03,
    0x81, 0x02, 0x75, 0x04, 0x95, 0x01, 0x81, 0x03, 0x05, 0x01, 0x09, 0x30, 0x26, 0xFF, 0x7F, 0x75,
    0x10, 0x95, 0x01, 0x81, 0x02, 0x09, 0x31, 0x81, 0x02, 0xC0, //     End Collection
    // Contact Count + Scan Time + Button 1
    0x05, 0x0D, 0x09, 0x54, //     Usage (Contact Count)
    0x25, 0x02, //     Logical Max (2)
    0x75, 0x08, //     Report Size (8)
    0x95, 0x01, 0x81, 0x02, 0x09, 0x56, //     Usage (Scan Time)
    0x27, 0xFF, 0xFF, 0x00, 0x00, // Logical Max (0xFFFF)
    0x75, 0x10, 0x95, 0x01, 0x81, 0x02, 0x05, 0x09, //     Usage Page (Button)
    0x09, 0x01, //     Usage (Button 1)
    0x15, 0x00, 0x25, 0x01, 0x75, 0x01, 0x95, 0x01, 0x81, 0x02, 0x75, 0x07, //     padding
    0x81, 0x03, 0xC0, //   End Collection
    // Configuration TLC (Feature report ID 3) — Device Mode
    0x05, 0x0D, 0x09, 0x0E, // Usage (Configuration)
    0xA1, 0x01, // Collection (Application)
    0x85, 0x03, //   Report ID (3)
    0x09, 0x22, //   Usage (Finger)
    0xA1, 0x02, //   Collection (Logical)
    0x09, 0x60, //     Usage (Device Mode)
    0x15, 0x00, 0x25, 0x0A, //     Logical Max (10)
